...
from list_app.views.task import add_task_view, display_task_view, update_view, delete_task_view, delete_confirmed_view
...
urlpatterns = [
    ...
    path('task/delete_confirmed/<int:pk>', delete_confirmed_view, name='deleted'),
